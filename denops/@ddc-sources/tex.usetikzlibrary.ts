...
export class Source extends BaseSource<Params> {
  ...
  override async onInit(_args: OnInitArguments<Params>): Promise<void> {
    async function candidates(cached = true) {
      if (cached) {
        return await Promise.all([
          ...
          "tex/generic/tikz-ext/tikzlibraryext.arrows-plus.code.tex",
          "tex/generic/tikz-ext/tikzlibraryext.beamer.code.tex",
          ...
          "tex/generic/tikz-ext/tikzlibraryext.topaths.autobend.code.tex",
          "tex/generic/tikz-ext/tikzlibraryext.transformations.mirror.code.tex",
          "tex/latex/aiplans/tikzlibraryaiplans.code.tex",
          ...
          "tex/latex/tikz-bpmn/tikzlibrarybpmn.code.tex",
          ...
          "tex/latex/tikz-nfold/pgflibrarynfold.code.tex",
          "tex/latex/tikz-nfold/pgflibraryoffsetpath.code.tex",
          ...
          "tex/latex/tikzducks/tikzlibraryducks.code.tex",
          ...
          "tex/latex/tilings/tikzlibrarypenrose.code.tex",
          "tex/latex/tilings/tikzlibrarytilings.code.tex",
          "tex/latex/tilings/tikzlibrarytilings.penrose.code.tex",
          "tex/latex/tilings/tikzlibrarytilings.polykite.code.tex",
    ...
    this.candidates = await candidates().then((cs) =>
      cs.map((word) => word.replace(/^.+\//, "").replace(/\.code\.tex$/, ""))
    );
  }
